...
@section('page-class', 'admin-dashboard')
            ...
            <div class="card-deck">
                <div class="card">
                    ...
                    <div class="card-body p-0 pt-5 pb-5">
                        <div class="mt-3 row justify-content-center">
                            <div class="col-6">
                                <canvas id="ct-cpu-usage-chart" width="250" height="250"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body p-0 pt-5 pb-5">
                        <div class="mt-3 row justify-content-center">
                            <div class="col-6">
                                <canvas id="ct-memory-usage-chart" width="250" height="250"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--
    jQuery(document).ready(function($) {
        ...
        let wv_cpu_usage_chart = document.getElementById('ct-cpu-usage-chart').getContext('2d');
        let wv_memory_usage_chart = document.getElementById('ct-memory-usage-chart').getContext('2d');
