{{-- Stored in /resources/views/admin/products/types/create.blade.php --}}
@extends('admin.layouts.master')
@section('html-title', 'Add Product Type')
@section('page-class', 'admin-product-types-create')
...
@section('content-body')
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="header">
                <span class="font-lg-size font-weight-bold">{{ __('Add Product Type') }}</span>
            </div>
            <div class="card">
                ...
                <div class="card-body pt-5 pb-5">
                    <div class="row">
                        <div class="col-sm-10">
                            @component('components.forms.form', ['method' => 'POST', 'action' => route('admin.product_types.store')])
                                @component('components.forms.input', ['id' => 'label', 'type' => 'text', 'name' => 'label', 'label' => 'Label', 'value' => old('label'), 'placeholder' => 'Bundled'])
                                    @error('label')
