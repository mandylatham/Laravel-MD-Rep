...
containerForgot = $('.container-forgot'),
showSignIn = true,
showSignUp = false;

function changeContainer(){
	containerSignIn.find("form")[0].reset();
	containerForgot.find("form")[0].reset();
	$(".alert").addClass("d-none");
	if(showSignIn == true){
		containerSignIn.removeClass('d-none');
	} else {
		containerSignIn.addClass('d-none')
	}

	if(showSignUp == true){
		containerForgot.removeClass('d-none')
	} else {
		containerForgot.addClass('d-none')
	}
}
